          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-[10px] font-bold text-purple-400 bg-purple-950/80 px-2 py-0.5 rounded border border-purple-800/40 flex items-center gap-1">
              ...
              <input
                ...
                className="w-full bg-[#0a0c18] border border-indigo-950/80 rounded-xl px-3.5 py-2.5 text-xs text-purple-300 font-black font-mono focus:outline-none cursor-not-allowed select-none opacity-80"
                placeholder={`#${order.order_number}`}
                title="Order ID is auto-generated by the system and cannot be modified."
              />
            </div>
